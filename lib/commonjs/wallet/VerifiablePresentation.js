...
exports.WalletPresentationBuilder = void 0;
 ...
 */
const WalletPresentationBuilder = exports.WalletPresentationBuilder = {
  /**
   * Create a Verifiable Presentation from a credential with selective disclosure.
   */
  create(params) {
    const disclosed = (0, _SelectiveDisclosure.applyDisclosure)(params.profile, params.credential);
